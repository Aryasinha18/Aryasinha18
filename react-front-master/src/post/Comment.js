...
class Comment extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h2 className="mt-5 mb-5 text-white">Leave a comment</h2>
                ...
                <form onSubmit={this.addComment}>
                    <div className="form-group">
                        ...
                        />
                        <button className="btn btn-raised btn-success mt-2 btn-lg" style={{borderRadius:"20px"}}>
                            Post
                        </button>
                    </div>
                </form>
                    ...
                    {comments.map((comment, i) => (
                        <div key={i}>
                            <div>
                                ...
                                <div>
                                    <h4 className="lead text-white">{comment.text}</h4>

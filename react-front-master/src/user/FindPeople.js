...
class FindPeople extends Component {
    ...
    renderUsers = users => (
      <div class="row">
            ...
            {users.map((user, i) => (
                <div className="col-sm-6 col-md-3 ml-5 mb-3"style={{backgroundColor: "white",border:"2px solid black",borderRadius:"30px", width: "28rem"}} key={i}>
    ...
    render() {
      ...
      padding: "15px",
      textAlign:"center"
    }}> <span>&nbsp;&nbsp;</span> Find People <span>&nbsp;&nbsp;</span></div></h3>
